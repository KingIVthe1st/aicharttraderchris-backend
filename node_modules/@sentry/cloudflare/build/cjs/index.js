...
const durableobject = require('./durableobject.js');
const pagesPlugin = require('./pages-plugin.js');
const request = require('./request.js');
const client = require('./client.js');
const sdk = require('./sdk.js');
const fetch = require('./integrations/fetch.js');
const vercelai = require('./integrations/tracing/vercelai.js');
...
exports.growthbookIntegration = core.growthbookIntegration;
...
exports.withSentry = handler.withSentry;
exports.instrumentDurableObjectWithSentry = durableobject.instrumentDurableObjectWithSentry;
exports.sentryPagesPlugin = pagesPlugin.sentryPagesPlugin;
exports.wrapRequestHandler = request.wrapRequestHandler;
exports.CloudflareClient = client.CloudflareClient;
exports.getDefaultIntegrations = sdk.getDefaultIntegrations;
exports.fetchIntegration = fetch.fetchIntegration;
exports.vercelAIIntegration = vercelai.vercelAIIntegration;
exports.honoIntegration = hono.honoIntegration;
exports.instrumentD1WithSentry = d1.instrumentD1WithSentry;
exports.instrumentWorkflowWithSentry = workflows.instrumentWorkflowWithSentry;
exports.setAsyncLocalStorageAsyncContextStrategy = async.setAsyncLocalStorageAsyncContextStrategy;
