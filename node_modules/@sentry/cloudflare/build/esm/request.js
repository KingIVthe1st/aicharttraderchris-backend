import { withIsolationScope, parseStringToURLObject, getHttpSpanDetailsFromUrlObject, httpHeadersToSpanAttributes, winterCGHeadersToDict, SEMANTIC_ATTRIBUTE_SENTRY_OP, captureException, flush, continueTrace, startSpanManual, setHttpStatus } from '@sentry/core';
import { addCloudResourceContext, addRequest, addCultureContext } from './scope-utils.js';
import { init } from './sdk.js';
import { classifyResponseStreaming } from './utils/streaming.js';
